    ...
    <div className="max-w-7xl mx-auto px-6 py-12">
      <section className="bg-natural-100 p-10 md:p-16 rounded-[32px] border border-natural-300">
        <div className="flex justify-between items-end mb-12 border-b border-natural-300 pb-6">
          <h2 className="text-xs uppercase tracking-[0.3em] text-natural-400 font-bold">
            Selected Research Projects
          </h2>
          <span className="text-[10px] text-natural-500 font-bold underline cursor-pointer hover:text-natural-800 transition-colors">
            ARCHIVE / 2026
          </span>
        </div>
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="flex flex-col md:flex-row md:items-start md:gap-12">
                <p className="text-[10px] font-bold text-natural-500 mb-2 md:mb-0 md:w-20 pt-2 tracking-widest">
                  {project.date}
                </p>
